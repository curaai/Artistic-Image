...
def load_vgg_model(model_path):
    ...
    'conv3_1 = 10' 'relu3_1 = 11' 'conv3_2 = 12' 'relu3_2 = 13' 'conv3_3 = 14' 'relu3_3 = 15' 'conv3_4 = 16'
    'relu3_4 = 17' 'pool3   = 18'
    'conv4_1 = 19' 'relu4_1 = 20' 'conv4_2 = 21' 'relu4_2 = 22' 'conv4_3 = 23' 'relu4_3 = 24' 'conv4_4 = 25'
    'relu4_4 = 26' 'pool4   = 27'
    'conv5_1 = 28' 'relu5_1 = 29' 'conv5_2 = 30' 'relu5_2 = 31' 'conv5_3 = 32' 'relu5_3 = 33' 'conv5_4 = 34'
    'relu5_4 = 35' 'pool5   = 36'
    'fc6     = 37'
    'relu6   = 38'
    'fc7     = 39'
    ...
    def _weights_and_bias(layer):
        W = vgg_layers[0][layer][0][0][2][0][0].astype('float64')
        b = vgg_layers[0][layer][0][0][2][0][1].astype('float64')
        return W, b
    ...
    graph = dict()
    graph['input']    = tf.Variable(np.zeros((1, IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_CHANNEL)))
